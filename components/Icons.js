// Minimal SVG icon components — stroke-based, currentColor, Lucide-compatible
...
export const IconHourglass = ({ size = 16, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
    <path d="M5 22h14"/>
    <path d="M5 2h14"/>
...
export const IconInbox = ({ size = 40, ...p }) => (
...
export const IconTrophy = ({ size = 24, ...p }) => (
...
export const IconSoccer = ({ size = 20, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
    <circle cx="12" cy="12" r="10"/>
    <path d="m12 8-3 2.5 1 3.5h4l1-3.5z"/>
    <path d="m9 10.5-4 1M19 11.5l-4-1M10 14l-1.5 3.5M14 14l1.5 3.5"/>
  </svg>
);

export const IconBarChart = ({ size = 18, ...p }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...p}>
